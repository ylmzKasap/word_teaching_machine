...
export function AskFromPicture(props) {
    ...
    const pageItems = [
        ...
        <TextOptions
            allPaths={allPaths} allWords={allWords} imgPath={imgPath}
            word={word} animateImg={animateImage} key={word + '-option'} />,

        <IntroImage imgPath={imgPath} word={word} imageAnimation={imageAnimation} key={word + '-image'} />    
    ]
